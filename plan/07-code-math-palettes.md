...
- Fallback rule (decided 2026-09-13): per-category `always-fallback-to-qwerty` stays a manual user toggle only. Plugin/expansion keyboards (Nepali-QWERTY etc.) registering alongside built-in QWERTY is deferred — see `22-qwerty-parity.md` (built-in QWERTY contract ships first) and `24-friend-ready.md`.
